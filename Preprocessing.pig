...
000 metres" is read as the value of the last field of the tuple, the Medal one. */ 

-------------------------------------------------------cleaning--------------------------------------------------------------------------------------

--set null values to 0 for age, height and weight columns 
nonull = FOREACH data GENERATE Name, Sex, (Age is null ? 0 : Age) AS Age, (Height is null ? 0.0 : Height) AS Height,
(Weight is null ? 0.0 : Weight) AS Weight, Team, NOC, Games, Year, Season, City, Sport, Event, Medal;
